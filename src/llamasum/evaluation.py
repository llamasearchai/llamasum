...
def calculate_bleu(summary: str, reference: str) -> float:
    ...
    try:
        ...
        return sentence_bleu(
            [reference_tokens], summary_tokens, smoothing_function=smoothing
        )
    except Exception as e:
...
def calculate_readability(text: str) -> Dict[str, float]:
    ...
    return {"flesch_reading_ease": flesch, "automated_readability_index": ari}


def evaluate_summary(
    summary: str, original_text: str, reference_summary: Optional[str] = None
    ...
    results["similarity_to_original"] = calculate_cosine_similarity(
    ...
    if reference_summary:
        ...
        results["similarity_to_reference"] = calculate_cosine_similarity(
