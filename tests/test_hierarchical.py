...
class TestHierarchicalSummarizer(unittest.TestCase):
    ...
    def test_summarize_with_three_levels(self, mock_split):
        ...
        mock_split.return_value = ["Sentence 1.", "Sentence 2.", "Sentence 3.", 
                                   ...
                                   "Sentence 10.", "Sentence 11.", "Sentence 12."]
        ...
        # Test
        result = self.hierarchical_summarizer.summarize("Sample text with multiple sentences.")
    ...
    def test_summarize_by_sections(self, mock_split_sections):
        ...
        with patch("llamasum.hierarchical.remove_redundant_sentences",
                  side_effect=lambda x, **kwargs: x):
            # Test
            result = self.hierarchical_summarizer.summarize_by_sections("Sample text with multiple sections.")
            ...
            self.assertEqual(result["overall_summary"], "Overall summary of all sections.")
    ...
    def test_generate_ultra_short(self):
        ...
        longer_text = "This is a much longer text that contains more than thirty words. " \
