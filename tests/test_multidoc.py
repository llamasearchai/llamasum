...
class TestMultiDocSummarizer(unittest.TestCase):
    ...
    def test_summarize_multiple_documents_with_default_strategy(self, mock_extract_summarize):
    ...
    def test_summarize_with_iterative_strategy(self, mock_iterative):
        ...
        documents = ["Document 1.", "Document 2.", "Document 3."]
        result = self.multidoc_summarizer.summarize(
            documents,
            strategy="iterative"
        )
        
        # It should use the iterative strategy
        mock_iterative.assert_called_once_with(
            documents,
            self.config.max_length
        )
    ...
    def test_extract_then_summarize_strategy(self, mock_extract, mock_split):
        ...
        # Set up the summarize method to return a summary
        self.mock_summarizer.summarize.return_value = "Summary using extract-then-summarize."
        ...
        all_sentences = ["Doc1 Sentence 1.", "Doc1 Sentence 2.", 
                         "Doc2 Sentence 1.", "Doc2 Sentence 2.",
                         "Doc3 Sentence 1.", "Doc3 Sentence 2."]
        ...
        with patch("llamasum.multidoc.split_into_sentences") as mock_split:
            ...
            with patch("llamasum.multidoc.MultiDocSummarizer._extract_important_sentences") as mock_extract:
    ...
    def test_summarize_with_queries(self):
        ...
        # Set up mocks
        self.multidoc_summarizer.summarize = MagicMock(return_value={
        ...
        self.assertEqual(
            self.multidoc_summarizer._extract_query_relevant_content.call_count,
            2
        )
