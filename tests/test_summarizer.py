...
class TestLlamaSummarizer(unittest.TestCase):
    ...
    def setUp(self, mock_model_class, mock_tokenizer_class):
        ...
        self.config = SummarizerConfig(
            model_name="test/model", device="cpu", max_length=100, min_length=20
        )
    ...
    def test_summarize_long_text(self, mock_preprocess, mock_split, mock_extract):
        ...
        # Test
        result = self.summarizer.summarize(
            "This is a longer text. It has multiple sentences."
        )
    ...
    def test_batch_summarization(self):
        ...
        self.summarizer.summarize = MagicMock(
            side_effect=["Summary 1", "Summary 2", "Summary 3"]
        )

        # Test
        results = self.summarizer.summarize_batch(
