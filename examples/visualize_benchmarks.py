...
def main():
    ...
    if len(results_list) > 1:
        ...
        plot_metrics_comparison(
            results_list, figsize=(10, 6), output_path=str(comparison_path)
        )
    ...
    for i, result in enumerate(results_list):
        ...
        doc_metrics_path = (
            output_dir / f"document_metrics_{summarizer_type}.{args.format}"
        )
        plot_document_metrics(
            result, figsize=(10, 6), output_path=str(doc_metrics_path), max_docs=5
        )
    ...
    for i, result in enumerate(results_list):
        ...
        if has_rouge:
            ...
            plot_rouge_breakdown(result, figsize=(12, 5), output_path=str(rouge_path))
